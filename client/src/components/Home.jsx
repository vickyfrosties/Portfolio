      ...
      <section className="grid grid-cols-3 grid-rows-3 flex-col min-h-lvh p-5 gap-10 w-full max-lg:gap-5 max-md:grid-cols-2 max-sm:flex max-sm:border-0 max-md:border-0 2xl:grid-rows-2 2xl:h-full max-lg:grid-rows-2">
        <div className="bg-yellow-200 row-span-2 rounded-lg max-2xl:row-start-1 max-2xl:row-end-3 2xl:row-span-1 max-lg:row-span-1 min-h-[250px]">
          <div className="rounded-lg h-full relative">
            ...
            <div className="h-185 w-full z-0 absolute bottom-0 max-md:relative max-md:h-80 max-2xl:h-full max-lg:h-80 max-md:flex max-md:justify-center max-xs:h-50 2xl:h-full">
              <img
        ...
        <div className="bg-slate-200 rounded-lg p-12 flex flex-col justify-center items-center overflow-hidden max-md:min-h-64">
          <Slider />
        </div>
          ...
          <section className="flex w-full justify-between max-md:justify-between max-sm:justify-around max-xs:flex max-xs:flex-col max-xs:gap-3 max-xs:justify-between 2xl:size-full max-lg:h-full max-lg:flex-col">
            ...
            >
              <a
                ...
                target="_blank"
                className="bg-slate-50 rounded-lg p-2 flex flex-col justify-center items-center max-md:h-30 max-md:w-full max-xs:flex-row max-lg:size-full max-lg:rounded-none max-xl:size-full max-2xl:size-full 2xl:size-full"
              >
                <svg
            ...
            >
              <a
                ...
                className="bg-slate-50 rounded-lg p-2 flex flex-col justify-center items-center max-md:h-30 max-md:w-full max-sm:w-full max-xs:flex-row max-lg:size-full max-lg:rounded-none max-xl:size-full max-2xl:size-full 2xl:size-full"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
