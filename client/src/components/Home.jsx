            ...
            <section className="flex w-full justify-between max-md:justify-between">
              ...
              >
                ...
                >
                  ...
                  <p className="text-center w-full pt-2 max-sm:hidden">
                    Find me on LinkedIn.
                  </p>
                </a>
              </div>
              ...
              >
                <a
                  ...
                  className="bg-slate-200 rounded-lg p-2 flex flex-col justify-center items-center max-md:h-30 max-sm:w-full"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="40"
              ...
              <div className="flex flex-col justify-center items-center w-50 max-sm:w-20">
                <a
                ...
                >
                  ...
                  <p className="text-center w-full max-sm:hidden">
