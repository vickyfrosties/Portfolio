...
const Home = ({ className }) => {
  ...
  return (
    <>
      <section className="grid grid-cols-3 grid-rows-3 2xl:bg-red-200 flex-col min-h-lvh p-5 gap-10 w-full max-lg:gap-5 border-b-1 max-md:grid-cols-2 max-sm:flex max-sm:border-0 max-md:border-0 2xl:grid-rows-2  2xl:h-full">
